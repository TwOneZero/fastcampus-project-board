...
//                .andExpect(model().attributeExists("searchTypes"));
    ...
    @Test
    public void givenSearchKeyword_whenSearchingArticleView_thenReturnsIt() throws Exception {
        //Given
...
//                .andExpect(model().attributeExists("searchTypes"));
    ...
    @WithMockUser  // 가짜 유저를 생성해 인증을 통과  -> 실제 사용자 정보 사용X
    @DisplayName("[view]:[GET] 게시글 페이지 - 정상호출 / 인증된 유저")
    @Test
...
//    @Test
//    public void givenNothing_whenRequestingArticleSearchView_thenReturnsIt() throws Exception {
//        //Given
//
//        //When&Then
...
//    }
    ...
    @WithUserDetails(value = "testuser", setupBefore = TestExecutionEvent.TEST_EXECUTION /* 빈이 하나이므로 안써도 됨 userDetailsServiceBeanName = "userDetailsService"*/)
...
//                                .with(user()) <- 어노테이션을 통해 인증 통과
    ...
    @DisplayName("[view][GET] 게시글 수정 페이지 - 인증 없을 때는 로그인 페이지 이동")
    @Test
    ...
    @Test
    public void givenNothing_whenRequestingArticleSearchHashtagView_thenReturnsIt() throws Exception {
        //Given
    ...
    @Test
    public void givenHashtag_whenRequestingArticleSearchHashtagView_thenReturnsIt() throws Exception {
        //Given
        String hashtag = "#java";
        List<String> hashtags = List.of("#java", "#spring", "#boot");
    ...
    private ArticleWithCommentsDto createArticleWitheCommentsDto() {
